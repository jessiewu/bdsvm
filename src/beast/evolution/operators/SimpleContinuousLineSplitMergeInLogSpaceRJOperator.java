 ...
 * @author Chieh-Hsi Wu
 */
public class SimpleContinuousLineSplitMergeInLogSpaceRJOperator extends Operator {
    ...
    private double split() throws Exception{
        ...
        double logq = proposeValueInLogSpace(parameterList,categoryIndex,parametricDistribution);
    ...
    private double merge() throws Exception{
        ...
        double logq = mergeValueInLogSpace(parameterList,mergeIndex,parametricDistribution);
